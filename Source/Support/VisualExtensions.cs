...
/// <summary>
/// Extension methods and attached properties for <see cref="Microsoft.UI.Composition.Visual"/> objects
/// </summary>
public static class VisualExtensions
{
    ...
    static string GetAnchorPointForElement(UIElement element)
    {
        var visual = GetVisual(element);
        return visual.AnchorPoint.ToString();
    }

    static void SetAnchorPointForElement(string value, UIElement element)
    {
        var visual = GetVisual(element);
        visual.AnchorPoint = value.ToVector2();
    }

    static string GetCenterPointForElement(UIElement element)
    {
        var visual = GetVisual(element);
        return visual.CenterPoint.ToString();
    }

    static void SetCenterPointForElement(string value, UIElement element)
    {
        var visual = GetVisual(element);
        visual.CenterPoint = value.ToVector3();
    }

    static string GetOffsetForElement(UIElement element)
    {
        var visual = GetVisual(element);
        return visual.Offset.ToString();
    }

    static void SetOffsetForElement(string value, UIElement element)
    {
        var visual = GetVisual(element);
        visual.Offset = value.ToVector3();
    }

    static string GetTranslationForElement(UIElement element)
    {
    ...
    static void SetTranslationForElement(string value, UIElement element)
    {
    ...
    static double GetOpacityForElement(UIElement element)
    {
        var visual = GetVisual(element);
        return visual.Opacity;
    }

    static void SetOpacityForElement(double value, UIElement element)
    {
        var visual = GetVisual(element);
        visual.Opacity = (float)value;
    }

    static double GetRotationAngleForElement(UIElement element)
    {
        var visual = GetVisual(element);
        return visual.RotationAngle;
    }

    static void SetRotationAngleForElement(double value, UIElement element)
    {
        var visual = GetVisual(element);
        visual.RotationAngle = (float)value;
    }

    static double GetRotationAngleInDegreesForElement(UIElement element)
    {
        var visual = GetVisual(element);
        return visual.RotationAngleInDegrees;
    }

    static void SetRotationAngleInDegreesForElement(double value, UIElement element)
    {
        var visual = GetVisual(element);
        visual.RotationAngleInDegrees = (float)value;
    }

    static string GetRotationAxisForElement(UIElement element)
    {
        var visual = GetVisual(element);
        return visual.RotationAxis.ToString();
    }

    static void SetRotationAxisForElement(string value, UIElement element)
    {
        var visual = GetVisual(element);
        visual.RotationAxis = value.ToVector3();
    }

    static string GetScaleForElement(UIElement element)
    {
        var visual = GetVisual(element);
        return visual.Scale.ToString();
    }

    static void SetScaleForElement(string value, UIElement element)
    {
        var visual = GetVisual(element);
        visual.Scale = value.ToVector3();
    }

    static string GetSizeForElement(UIElement element)
    {
        var visual = GetVisual(element);
        return visual.Size.ToString();
    }

    static void SetSizeForElement(string value, UIElement element)
    {
        var visual = GetVisual(element);
    ...
    public static readonly DependencyProperty TranslationProperty =
        DependencyProperty.RegisterAttached("Translation", 
            typeof(string), 
            typeof(VisualExtensions), 
            new PropertyMetadata(null, OnTranslationChanged));
    ...
    public static readonly DependencyProperty NormalizedCenterPointProperty =
        DependencyProperty.RegisterAttached("NormalizedCenterPoint", 
            typeof(string), 
            typeof(VisualExtensions), 
            new PropertyMetadata(false, OnNormalizedCenterPointChanged));

    static void OnAnchorPointChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
    ...
    static void OnCenterPointChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        if (e.NewValue is string str)
        {
    ...
    static void OnTranslationChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        if (e.NewValue is string str)
        {
    ...
    static void OnRotationAngleInDegreesChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        if (e.NewValue is double dbl)
        {
    ...
    static void OnRotationAxisChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        if (e.NewValue is string str)
        {
    ...
    static void OnNormalizedCenterPointChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        if (d is FrameworkElement element && e.NewValue is string newValue)
        {
