...
#pragma warning disable 8714 // The type cannot be used as type parameter in the generic type or method. Nullability of type argument doesn't match 'notnull' constraint.
    ...
    /// </summary>
    public static string GetRandomTechnicalSentence(int wordCount)
    {
    ...
    static string lastSentence = string.Empty;
    /// <summary>
    ...
    public static string GenerateSentence(bool prefab = true)
    {
        ...
        */
        ...
        if (output.Equals(lastSentence))
            output = statements[Random.Shared.Next(statements.Length)];
        else
            lastSentence = output;
