...
{
    public static string DefinitionId { get; } = "Counting_Widget";
    ...
    public override void OnWidgetContextChanged(WidgetContextChangedArgs contextChangedArgs)
    {
        ...
        // 1. If you need to adjust template/data for the new context (i.e. widget size has changed) - you can do it here.
    ...
    private static string GetDefaultTemplate()
    {
        if (string.IsNullOrEmpty(WidgetTemplate))
        {
            ...
            WidgetTemplate = ReadPackageFileFromUri("ms-appx:///Widget/Templates/CountingWidgetTemplate.json");
        }
    ...
    public override string GetDataForWidget()
    {
        ...
        Debug.WriteLine(stateNode.ToString());
